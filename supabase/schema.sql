...
COMMENT ON TABLE public.assessments IS 'Tabel penyimpan seluruh profil, kertas kerja Lampiran IV, skor RMI, dan checklist dokumen asesmen maturitas risiko BUMN.';
COMMENT ON COLUMN public.assessments.id IS 'ID unik asesmen, misalnya: assessment-1711000000000 atau pt-abc-2022';
COMMENT ON COLUMN public.assessments.data IS 'Payload JSONB lengkap: { profile, assessments, performance, documentChecklist, recommendations, dimensionSummaries }';
